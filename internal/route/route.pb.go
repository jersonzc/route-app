...
const file_proto_route_proto_rawDesc = "" +
	"\n" +
	"\x11proto/route.proto\x12\x05route\"A\n" +
	"\x05Point\x12\x1a\n" +
	...
	"\tRouteChat\x12\x10.route.RouteNote\x1a\x10.route.RouteNote\"\x00(\x010\x01B\x1aZ\x18route-app/internal/routeb\x06proto3"
